...
/**
 * Provides the local service interface for AutoDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AutoDetailsLocalServiceUtil
...
public interface AutoDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AutoDetailsLocalServiceUtil} to access the auto details local service. Add custom service methods to {@link com.autodetservice.service.impl.AutoDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AutoDetails fetchAutoDetailsByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AutoDetails getAutoDetailsByUuidAndGroupId(java.lang.String uuid,
